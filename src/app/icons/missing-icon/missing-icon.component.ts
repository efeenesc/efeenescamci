...
@Component({
  ...
  imports: [],
  template: `
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="{{this.applyClass()}}">
    ...
    <path d="M17 3L19 5M21 7L19 5M19 5L21 3M19 5L17 7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
  `
})
